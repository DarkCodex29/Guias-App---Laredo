...
class PartidaPage extends StatelessWidget {
  ...
  AppBar _buildAppBar(BuildContext context, PartidaController controller) {
    return AppBar(
      title: const Text('Partida', style: TextStyle(color: AppColors.white)),
  ...
  Widget _buildMobileLayout(BuildContext context, PartidaController controller,
  ...
  Widget _buildDesktopLayout(BuildContext context, PartidaController controller,
      GuideFlowController flowController) {
    return Row(
      children: [
  ...
  Widget _buildFormFields(PartidaController controller) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        CustomTextField(
          label: 'Dirección',
          hint: 'Ingrese la dirección de partida',
  ...
  Widget _buildSidebar() {
    return Column(
      ...
      children: const [
        ...
        SizedBox(height: 24),
        Text(
          'Ingrese la dirección completa y seleccione el Departamento, Provincia y Distrito desde donde se inicia el traslado de los bienes.',
  ...
  Widget _buildNavigationButtons(BuildContext context,
      PartidaController controller, GuideFlowController flowController) {
    final progress =
  ...
  void _onNextButtonPressed(BuildContext context, PartidaController controller,
      GuideFlowController flowController) {
